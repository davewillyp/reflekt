...
new class extends Component {
    ...
    public function getComments($id){
        ...
        $reflect = Reflekt::find($id);
        $this->comments = $reflect->comments->user;
        $this->reflektId = $id;         
    }

    public function postComment(){
        Reflekt::find($this->reflektId)->comments()->create([
            'comment' => $this->comment,
            'user_id' => Auth::id()
        ]);
        $this->getComments($this->reflektId);
    }
                  ...
                  <div class="p-4 md:p-5">
                      <ol class="relative border-s border-gray-200 dark:border-gray-600 ms-3.5 mb-4 md:mb-5">
                            @foreach($this->comments as $comment)                  
                                <li class="mb-10 ms-8" wire:key('{{ $comment->id }}')>            
                      ...
                      <form wire:submit="postComment">                    
                        ...
                        <textarea wire:model="comment" id="message" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write your thoughts here...">{{$this->words}}</textarea>
                        <button type="submit" class="text-white bg-lime-500 hover:bg-lime-600 focus:ring-4 focus:outline-none focus:ring-lime-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Post</button>
                      </form>
